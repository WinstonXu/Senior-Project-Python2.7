...
def loadCompositePics():
    ...
    # print X.shape
    train_2d = np.reshape(train_img, (len(train_img), 1, 84, 28))
    test_2d = np.reshape(test_img, (len(test_img), 1, 84, 28))
...
def createConv():
    ...
    #change convolution
    model.add(Convolution2D(32, 5, 5, border_mode='valid', input_shape=(1,84,28)))
